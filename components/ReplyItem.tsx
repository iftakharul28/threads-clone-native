...
export default function ReplyItem({ author, content, createdAt, id, likes }: Reply): JSX.Element {
  return (
    <View style={{ flexDirection: 'row', gap: 10 }}>
      ...
      <View style={{ flexShrink: 1, gap: 10 }}>
        <PostHeading name={author.name} createdAt={createdAt} verified={author.verified} />
        <Text>{content}</Text>
        <BottomIcons />
