  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <View style={styles.replyContainer}>
        <Image style={styles.image} placeholder={blurhash} contentFit='cover' transition={500} />
        <TextInput placeholder='Add reply' value={replyContent} onChangeText={setReplyContent} style={styles.input} />
